...
/*****************************************************************************/
...
#elif defined(HW_ENDPOINT_SIHIVE16)
	typedef char eint8;
	typedef signed char esint8;
	typedef unsigned char euint8;
	typedef int eint16;
	...
	typedef signed long esint32;
	typedef unsigned long euint32;
#elif defined(HW_ENDPOINT_SIHIVE32)
	typedef char eint8;
	typedef signed char esint8;
	typedef unsigned char euint8;
	typedef short eint16;
...
#if SAMPLESIZE == 16
	typedef esint16 sample_t;
	typedef esint16 stdvar_t;
	typedef euint16 stdvaru_t;
#endif
#if SAMPLESIZE == 32
	typedef esint32 sample_t;
	typedef esint32 stdvar_t;
	typedef euint32 stdvaru_t;
#endif
