/**********************************************************************************************************
/ VERSION 1.8.1 - Monica Jimenez, Laura Gutierrez
...
int8_t validation(int16_t rr,uint8_t detection[12]){
	...
	//rule 3: Twave.amplitude > 0  -->  como el valor de out[10] es la transformada tenemos que comprobar que sea negativa
